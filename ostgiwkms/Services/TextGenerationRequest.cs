...
namespace ostgiwkms.Services
{
    public class TextGenerationRequest
    {
        ...
        public async Task<string> GenerateNovel(string inputText, double _temperature, int _min_length, int _max_length)
        {
            string output = "";
            string apiURL = "https://api.novelai.net/ai/generate";
            ...
            */
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    dynamic generatedResponse = JsonConvert.DeserializeObject<dynamic>(responseData);
